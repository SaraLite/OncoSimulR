...
_in a real game of rock paper scissors_ (Kerr _et al._). It describes the 
relationship between three populations of _Escherichia coli_, that turns out 
to be very similar to a rock-paper-scissors game.
...
_Interactions in Multiple Myeloma_ (**referencia**) available at
...
fitness is the following (see **referencia**):
...
**referencia**. Here we reproduce some of them.
...
As in the second scenario of **referencia** ($c1=c2=c3$) configuration A (upper
...
**referencia** ($c3<c1<c2$) configuration A (left). If diffusion range
...
As specified in **referencia** there are two equilibrium points under this
...
2. Basanta, D., Scott, J., Fishman, M. _et al._ Investigating prostate cancer
...
X. Kaznatcheev, A., Vander Velde, R., Scott, J. et al. Cancer treatment
scheduling and dynamic heterogeneity in social dilemmas of tumour acidity and
vasculature. Br J Cancer 116, 785–792 (2017) doi:10.1038/bjc.2017.5
X. Kerr, B., Riley, M., Feldman, M. _et al._ Local dispersal promotes 
biodiversity in a real-life game of rock–paper–scissors. Nature 418, 171–174 
(2002) doi:10.1038/nature00823
X.  Sergio Sánchez Carrillo, Ramón Díaz Uriarte. Implementación del fitness
dependiente de la frecuencia genética en el paquete OncoSimulR (2018). -> TFM
X. Ramon Diaz-Uriarte, Sergio Sanchez-Carrillo. OncoSimulR: forward genetic
...
X. Chicken (game) [Internet]. En.wikipedia.org. 2020 [cited 7 January 2020]. 
Available from: https://en.wikipedia.org/wiki/Chicken_(game)
X. Williams BK, Nichols JD, Conroy MJ (Michael J. Analysis and management of 
