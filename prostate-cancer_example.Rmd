...
_in a real game of rock paper scissors_ [5]. It describes the relationship
...
analyzed. This classic game is: _Hawk and Dove_ [3], available at <https://en.wikipedia.org/wiki/Chicken_(game))>.
...
_Animal Populations"_ [9]. For the following examples S1 and S2 will be the two
species used, and can be interpreted as cellular clones competing for cellular
resources or multicellular organisms competing for environmental resources
(sexual or asexual reproduction is not relevant as it is incorporated in the
birth rate). 
...
[4], available at <https://doi.org/10.1038/bjc.2017.5>.
...
[2], available at <http://dx.doi.org/10.1038/bjc.2011.517>. 
...
_Interactions in Multiple Myeloma_ [7], available at
...
evolutionary game. Br J Cancer 106, 174–181 (2012) doi:10.1038/bjc.2011.517
...
[4]. Kaznatcheev, A., Vander Velde, R., Scott, J. et al. Cancer treatment
...
[5]. Kerr, B., Riley, M., Feldman, M. et al. Local dispersal promotes 
biodiversity in a real-life game of rock–paper–scissors. Nature 418, 171–174 
(2002) doi:10.1038/nature00823

[6]. Ramon Diaz-Uriarte, Sergio Sanchez-Carrillo. OncoSimulR: forward genetic
...
[7]. Sartakhti, J. S., Manshaei, M. H., Bateni, S., & Archetti, M. (2016). 
Evolutionary dynamics of tumor-stroma interactions in multiple myeloma. 
PloS one, 11(12), e0168856.

[8]. Sergio Sánchez Carrillo, Ramón Díaz Uriarte. Implementación del fitness
dependiente de la frecuencia genética en el paquete OncoSimulR (2018). -> TFM

[9]. Williams BK, Nichols JD, Conroy MJ Michael J. Analysis and management of
