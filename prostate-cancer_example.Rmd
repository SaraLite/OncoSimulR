...
- name: Miguel Hernandez del Valle
- name: Alvaro Huertas Garcia 
- name: Diego Mañanes Cayero
- name: Alejandro Martin Muñoz
...
In the project we have added two new functions (compositionPop2 and simul_boxplot2) to plot the reproducibility and distribution of the results of various simulations using boxplots (using ggplot2) . You can find these functions at _Functions_plot_markdown.R_. 
