...
fontsize: 12pt
abstract: |
   OncoSimulR, frequency-dependent fitness. Programming and Statistics with R 
...
source("./boxplot_stripchart_pop.R")
...
the last half of each simulation. As a boxplot would lose the information of the
different scenarios, we decided to plot the data as points and join with
