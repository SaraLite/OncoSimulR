...
plot(simulation[[1]], show = "genotypes", xlim = c(40, 500), lwdClone = 2, ylab = "Number of individuals", main = "Hawk and Dove trajectory")

par <- oldpar

## Agreement: Show boxplot from several simulations. 
compositionPop2(simulation, main = "Hawk and Dove trajectory", ylab = "Number of individuals")
```
